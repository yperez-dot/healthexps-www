...
(function (global) {
  ...
  var T = {
    en: {
      ...
      sep_warning_newmedicare: 'If you missed your IEP and do not have another SEP, you can sign up during the General Enrollment Period: <strong>January 1 – March 31</strong> each year. Since 2023, coverage starts the <strong>first day of the month after you enroll</strong> — not automatically July 1. You may still owe a late-enrollment penalty. Call us — we can check whether a Special Enrollment Period applies instead.',
    ...
    es: {
      ...
      sep_warning_newmedicare: 'Si perdió su IEP y no tiene otro SEP, puede inscribirse en el Período de Inscripción General: del <strong>1 de enero al 31 de marzo</strong> de cada año. Desde 2023, la cobertura empieza el <strong>primer día del mes siguiente a su inscripción</strong> — no automáticamente el 1 de julio. Puede haber penalidad por inscripción tardía. Llámenos — podemos ver si califica para un SEP.',
